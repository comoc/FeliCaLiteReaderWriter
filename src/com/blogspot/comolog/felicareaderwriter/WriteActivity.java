...
public class WriteActivity extends Activity {
	...
	protected void onResume() {
		...
		String[][] techList = new String[][] { { android.nfc.tech.NfcF.class
				.getName() } };
	...
	protected void onNewIntent(Intent intent) {
		...
		try {
			...
			Toast.makeText(getApplicationContext(), "this is not felica tag",
					Toast.LENGTH_SHORT).show();
			return;
		}
		...
		try {
			...
			Toast.makeText(getApplicationContext(), "TagLostException",
					Toast.LENGTH_SHORT).show();
			return;
		} catch (IOException e) {
		...
		try {
			...
			Toast.makeText(getApplicationContext(), "size over",
					Toast.LENGTH_SHORT).show();
			Log.w(LOG_TAG, e.getMessage());
			return;
		}

		Toast.makeText(getApplicationContext(), R.string.wrote_ndef,
